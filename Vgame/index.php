		...
		<body>
				...
				<div>
					<div class="inlinecenterblock">
						<div>
							...
							?>
							<a href="<?php echo $baseurl ?>"><img src="<?php echo $baseurl . $currentlogo ?>" style="height: 100px;"></a>
						</div>
			...
			<script>
				...
				function showcartui(){
					...
					cartdata += "<label><?php echo uilang("Delivery Method") ?></label><select id='cdmethod'><?php echo uilang("Delivery Method") ?><option>Take Away</option><option>Home Delivery</option><option>Cash on Delivery</option></select>"
