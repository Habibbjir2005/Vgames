						...
						<div class="adminmenubar">
							<div class="stickythingy">
								<div style="padding: 30px;">
									...
									?>
									<a target="_blank" href="<?php echo $baseurl ?>"><img src="<?php echo $currentlogo ?>" style="display: border-box; width: 100px; height: 100px"></a>
								</div>
				...
				<div class="loginform">
					<div style="text-align: center; padding: 20px;">
						...
						if($logo != "")
							$currentlogo = "pictures/" . $logo;
						?>
						<img src="<?php echo $currentlogo ?>" width="200"><br>
